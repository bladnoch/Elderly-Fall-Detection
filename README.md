...
- **사용 데이터 및 입력:**  
  - 입력 비디오 파일: `/test-video/input/cafe.mp4`  
  - 가구 정보는 안전가구 세그멘테이션 모델을 통해 추출됩니다.

- **알고리즘 및 모델:**  
  - **세그멘테이션 모델:** YOLOv8x-seg (안전가구 인식용)  
...
3. **입력 및 출력 비디오 경로 설정:**  
   - 입력 비디오 경로: `/test-video/input/cafe.mp4`  
   - 출력 비디오 경로: `/test-video/output/cafe-output.mp4`  
   경로는 사용 환경에 맞게 수정하세요.
...
- 관련 논문 및 참고 자료:
  - **논문 제목:** *노인 낙상사고 방지를 위한 모니터링 시스템 개발*
  - **저자 및 연도:** 홍길동, 강신후
...
- **풀 리퀘스트:** 새로운 기능 추가 또는 수정 사항을 브랜치로 작업한 후, 풀 리퀘스트(PR)를 제출해 주세요.
- **코드 스타일:** PEP8 가이드라인을 준수하고, 주석과 문서화를 충실히 해 주시기 바랍니다.
